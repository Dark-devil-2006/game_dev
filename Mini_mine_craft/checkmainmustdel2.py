...
# Create your light source (sun)
sun = DirectionalLight()
sun.look_at(Vec3(1, -1, -1))  # Position and angle of the sun
sun.shadows = True  # ✅ Enable shadows
sun.shadow_resolution = (1024, 1024)  # You can increase this for better quality
sun.shadow_bias = 0.02  # Tweak to avoid shadow acne
...
Entity(model='cube', texture='white_cube', position=(0,0.5,3), scale=1, cast_shadows=True)
